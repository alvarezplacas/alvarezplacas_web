...
async function deepSync() {
    console.log("--- 🚀 Iniciando Sincronización Profunda de Materiales (V2) ---");
    ...
    try {
        ...
        const materials = await client.request(readItems('materiales', { limit: -1, fields: ['id', 'nombre'] }));
        ...
        console.log(`📊 Materiales en DB: ${materials.length}`);
