...
async function getOrCreate(collection, nameField, nameValue, extraData = {}) {
    ...
    try {
        ...
        const created = await client.request(createItem(collection, { [nameField]: nameValue, ...extraData }));
        return created.id;
    } catch (e) {
...
async function run() {
    try {
        ...
        console.log(`Syncing ${rows.length} products to exact collections...`);
        ...
        for (const line of rows) {
            ...
            // COLECCIONES EXACTAS SEGÚN /relations
